...
```bash
git clone git@gitlab.com:mrobert280525/devops-takehome.git && cd devops-takehome
...
Container image (GitLab CI): `registry.gitlab.com/mrobert280525/devops-takehome:<git-sha>`
